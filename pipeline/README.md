...
<!-- BADGES:START -->
[![Transcripts](https://img.shields.io/badge/transcripts-289-brightgreen)]()
...
<!-- STATS:START -->
The vault currently holds **289 transcripts** from **105 channels** across **6 topics**:

| Topic | Transcripts | Channels | What's Covered |
|:------|:-----------:|:--------:|:---------------|
| **ai-llms** | 179 | 67 | Large language models, AI agents, prompt engineering, RAG, model tooling, and agent workflows |
