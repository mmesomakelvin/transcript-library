...
<!-- BADGES:START -->
[![Transcripts](https://img.shields.io/badge/transcripts-299-brightgreen)]()
...
<!-- STATS:START -->
The vault currently holds **299 transcripts** from **110 channels** across **6 topics**:

| Topic | Transcripts | Channels | What's Covered |
|:------|:-----------:|:--------:|:---------------|
| **ai-llms** | 184 | 72 | Large language models, AI agents, prompt engineering, RAG, model tooling, and agent workflows |
