...
<!-- BADGES:START -->
[![Transcripts](https://img.shields.io/badge/transcripts-261-brightgreen)]()
...
<!-- STATS:START -->
The vault currently holds **261 transcripts** from **95 channels** across **6 topics**:

| Topic | Transcripts | Channels | What's Covered |
|:------|:-----------:|:--------:|:---------------|
| **ai-llms** | 166 | 61 | Large language models, AI agents, prompt engineering, RAG, model tooling, and agent workflows |
