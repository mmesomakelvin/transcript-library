...
<!-- BADGES:START -->
[![Transcripts](https://img.shields.io/badge/transcripts-300-brightgreen)]()
[![Topics](https://img.shields.io/badge/topics-6-orange)]()
[![Channels](https://img.shields.io/badge/channels-110-purple)]()
<!-- BADGES:END -->
...
<!-- STATS:START -->
The vault currently holds **300 transcripts** from **110 channels** across **6 topics**:

| Topic | Transcripts | Channels | What's Covered |
|:------|:-----------:|:--------:|:---------------|
| **ai-llms** | 185 | 72 | Large language models, AI agents, prompt engineering, RAG, model tooling, and agent workflows |
