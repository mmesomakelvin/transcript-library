...
<!-- BADGES:START -->
[![Transcripts](https://img.shields.io/badge/transcripts-247-brightgreen)]()
...
<!-- STATS:START -->
The vault currently holds **247 transcripts** from **91 channels** across **6 topics**:

| Topic | Transcripts | Channels | What's Covered |
|:------|:-----------:|:--------:|:---------------|
| **ai-llms** | 155 | 57 | Large language models, AI agents, prompt engineering, RAG, model tooling, and agent workflows |
